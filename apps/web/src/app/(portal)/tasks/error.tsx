...
// The Tasks module's error boundary (09-ERROR-HANDLING §5.2).
//
// One `error.tsx` per route segment IS the isolation: Next wraps this segment's
// subtree and nothing else, so a throw in Tasks cannot take any other module down.
...
export default function TasksError(props: { error: Error & { digest?: string }; reset: () => void }) {
  return <ModuleError module="Tasks" {...props} />;
}
